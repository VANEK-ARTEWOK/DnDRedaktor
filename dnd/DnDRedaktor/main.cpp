...
txTextCursor (false);
     ...
     pic[0]={10,100,"картинки/расы/кенку.bmp",txLoadImage ("картинки/расы/кенку.bmp"),564,729,80,100,false,"–аса"};
     pic[1]={10,200,"картинки/расы/орк.bmp",txLoadImage ("картинки/расы/орк.bmp"),216,281,80,100,false,"–аса"};
     pic[2]={10,300,"картинки/расы/дварф.bmp",txLoadImage ("картинки/расы/дварф.bmp"),184,274,80,100,false,"–аса"};
     pic[3]={10,400,"картинки/расы/кот.bmp",txLoadImage ("картинки/расы/кот.bmp"),209,241,80,100,false,"–аса"};
     pic[4]={10,500,"картинки/расы/гоблин.bmp",txLoadImage ("картинки/расы/гоблин.bmp"),216,497,80,100,false,"–аса"};
     pic[5]={10,600,"картинки/расы/грунг.bmp",txLoadImage ("картинки/расы/грунг.bmp"),184,274,80,100,false,"–аса"};
     pic[6]={10,700,"картинки/расы/ааракана.bmp",txLoadImage ("картинки/расы/ааракана.bmp"),216,208,80,100,false,"–аса"};
     pic[7]={60,100,"картинки/расы/автогном.bmp",txLoadImage ("картинки/расы/автогном.bmp"),216,324,80,100,false,"–аса"};
     pic[8]={60,200,"картинки/расы/плазмоид.bmp",txLoadImage ("картинки/расы/плазмоид.bmp"),209,241,80,100,false,"–аса"};
     pic[9]={60,300,"картинки/расы/кованый.bmp",txLoadImage ("картинки/расы/кованый.bmp"),287,512,80,100,false,"–аса"};

     pic[10]={10,100,"картинки/брон€/шл€па.bmp",txLoadImage ("картинки/брон€/шл€па.bmp"),225,225,80,100,false,"одежда"};
     pic[11]={10,200,"картинки/брон€/нагрудник.bmp",txLoadImage ("картинки/брон€/нагрудник.bmp"),225,225,80,100,false,"одежда"};
     pic[12]={10,300,"картинки/брон€/маска.bmp",txLoadImage ("картинки/брон€/маска.bmp"),194,257,80,100,false,"одежда"};
     pic[13]={10,400,"картинки/брон€/чума.bmp",txLoadImage ("картинки/брон€/чума.bmp"),225,225,80,100,false,"одежда"};
     pic[14]={10,500,"картинки/брон€/шлем.bmp",txLoadImage ("картинки/брон€/шлем.bmp"),219,230,80,100,false,"одежда"};
     pic[15]={10,600,"картинки/брон€/ковбой.bmp",txLoadImage ("картинки/брон€/ковбой.bmp"),225,225,80,100,false,"одежда"};
