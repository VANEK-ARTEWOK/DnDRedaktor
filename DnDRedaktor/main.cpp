...
txTextCursor (false);
     ...
     int menu_butn_start = count_menu_butn -4;
     int menu_butn_help = count_menu_butn -3;
     int menu_butn_load = count_menu_butn -2;
     ...
     menu_butn[3]={670,330,150,35,"загрузить"};
     menu_butn[4]={670,380,150,35,"выход"};
